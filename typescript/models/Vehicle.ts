...
export function VehicleFromJSONTyped(json: any, ignoreDiscriminator: boolean): Vehicle {
    ...
    return {
        ...
        'serviceTimeFactor': !exists(json, 'serviceTimeFactor') ? undefined : json['serviceTimeFactor'],
        ...
        'maximumNumberOfCustomerStops': !exists(json, 'maximumNumberOfCustomerStops') ? undefined : json['maximumNumberOfCustomerStops'],
    };
}
