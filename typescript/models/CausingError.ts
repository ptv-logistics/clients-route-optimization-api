...
export interface CausingError {
     ...
     * * `ROUTEOPTIMIZATION_STOP_SERVICE_TIME_TOO_LONG` - The service time of the stop exceeds the travel time between daily rests or the working time between breaks defined by the rules for the driver.
