...
import com.ptvgroup.developer.client.routeoptimization.model.RoadAccess;
...
public class Location {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, type, latitude, longitude, roadAccess, includeLastMeters, matchSideOfStreet, applyVehicleDependentServiceTimeFactor, openingIntervals, depotLocationAttributes, customerLocationAttributes);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `applyVehicleDependentServiceTimeFactor` to the URL query string
    if (getApplyVehicleDependentServiceTimeFactor() != null) {
      joiner.add(String.format("%sapplyVehicleDependentServiceTimeFactor%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getApplyVehicleDependentServiceTimeFactor()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
