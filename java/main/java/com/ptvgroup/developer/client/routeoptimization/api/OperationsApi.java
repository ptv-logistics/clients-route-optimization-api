...
public class OperationsApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public void startOptimization(UUID id, OptimizationQuality quality, List<TweakToObjective> tweaksToObjective, Boolean considerTransportPriorities) throws ApiException {
    startOptimizationWithHttpInfo(id, quality, tweaksToObjective, considerTransportPriorities);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Void> startOptimizationWithHttpInfo(UUID id, OptimizationQuality quality, List<TweakToObjective> tweaksToObjective, Boolean considerTransportPriorities) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = startOptimizationRequestBuilder(id, quality, tweaksToObjective, considerTransportPriorities);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder startOptimizationRequestBuilder(UUID id, OptimizationQuality quality, List<TweakToObjective> tweaksToObjective, Boolean considerTransportPriorities) throws ApiException {
    // verify the required parameter 'id' is set
    if (id == null) {
