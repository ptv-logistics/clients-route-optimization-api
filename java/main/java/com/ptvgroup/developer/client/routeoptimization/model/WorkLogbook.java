 ...
 */
@ApiModel(description = "Defines the accumulated driving, working and travel times since the last break or daily rest.  See [here](./Concepts/Drivers%20Working%20Hours.htm) for more information.")
@JsonPropertyOrder({
