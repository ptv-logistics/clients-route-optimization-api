...
@JsonPropertyOrder({
  ...
  StopReport.JSON_PROPERTY_REST_TIME,
  StopReport.JSON_PROPERTY_QUANTITIES,
  StopReport.JSON_PROPERTY_ALTERNATIVE_CAPACITIES_INDEX
})
...
public class StopReport {
  ...
  public StopReport restTime(Integer restTime) {
  ...
  public StopReport alternativeCapacitiesIndex(Integer alternativeCapacitiesIndex) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.arrivalTime, stopReport.arrivalTime) &&
        ...
        Objects.equals(this.restTime, stopReport.restTime) &&
        Objects.equals(this.quantities, stopReport.quantities) &&
        equalsNullable(this.alternativeCapacitiesIndex, stopReport.alternativeCapacitiesIndex);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `alternativeCapacitiesIndex` to the URL query string
    if (getAlternativeCapacitiesIndex() != null) {
      joiner.add(String.format("%salternativeCapacitiesIndex%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getAlternativeCapacitiesIndex()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
