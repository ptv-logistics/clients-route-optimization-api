...
public class Plan {
  ...
  **/
  ...
  public Plan addLocationsItem(Location locationsItem) {
   ...
   /**
   * A list of depot or customer locations that may be referenced by vehicles, transports and stops. A location is either a depot location or a customer location. Depot locations act as trip delimiters.
   * @return locations
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "A list of depot or customer locations that may be referenced by vehicles, transports and stops. A location is either a depot location or a customer location. Depot locations act as trip delimiters.")
  ...
  **/
  ...
  public Plan addTransportsItem(Transport transportsItem) {
   ...
   /**
   * A list of transports, that is, orders to transport goods from one location to another location.
   * @return transports
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "A list of transports, that is, orders to transport goods from one location to another location.")
