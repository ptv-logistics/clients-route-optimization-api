...
@JsonPropertyOrder({
  ...
  Violation.JSON_PROPERTY_NUMBER_OF_STOPS_EXCEEDANCE,
...
public class Violation {
  ...
  public static final String JSON_PROPERTY_NUMBER_OF_STOPS_EXCEEDANCE = "numberOfStopsExceedance";
  private Integer numberOfStopsExceedance;
  ...
  **/
  ...
  @ApiModelProperty(value = "Specifies a violation that involves a time limit: Time by which the limit is exceeded. Is only filled for the following violation types: _PLANNING_HORIZON_, _ROUTE_START_INTERVAL_, _DRIVER_AVAILABILITY_, _OPENING_INTERVAL_, _MAXIMUM_TRAVEL_TIME_OF_DRIVER_, _MAXIMUM_DRIVING_TIME_OF_DRIVER_.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies a violation that involves a distance limit: Distance by which the limit is exceeded. Is only filled for the following violation type: _MAXIMUM_DISTANCE_.")
  ...
  public Violation numberOfStopsExceedance(Integer numberOfStopsExceedance) {
   ...
   * @return numberOfStopsExceedance
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies a violation that involves a stop limit: Number of stops by which the limit is exceeded. Is only filled for the following violation type: _MAXIMUM_NUMBER_OF_CUSTOMER_STOPS_.")
  @JsonProperty(JSON_PROPERTY_NUMBER_OF_STOPS_EXCEEDANCE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Integer getNumberOfStopsExceedance() {
    return numberOfStopsExceedance;
  }
  ...
  @JsonProperty(JSON_PROPERTY_NUMBER_OF_STOPS_EXCEEDANCE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setNumberOfStopsExceedance(Integer numberOfStopsExceedance) {
    this.numberOfStopsExceedance = numberOfStopsExceedance;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, violation.type) &&
        ...
        Objects.equals(this.numberOfStopsExceedance, violation.numberOfStopsExceedance) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, timeExceedance, distanceExceedance, numberOfStopsExceedance, capacityExceedance, missingEquipment, mixedLoadingProhibitions);
  }
  ...
  public String toString() {
    ...
    sb.append("    numberOfStopsExceedance: ").append(toIndentedString(numberOfStopsExceedance)).append("\n");
