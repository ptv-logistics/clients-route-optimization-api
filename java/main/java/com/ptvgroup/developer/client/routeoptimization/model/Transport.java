...
public class Transport {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The transport-dependent service time [s] that is required to pick up the transport goods at the pickup location.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The transport-dependent service time [s] that is required to deliver the transport goods at the delivery location.")
