...
public class PlanningRestrictions {
  ...
  **/
  ...
  @ApiModelProperty(value = "Restricts the number of trips per route to one.  See [here](./concepts/route-structure-control) for more information.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Restricts the number of different depot locations in the route of a vehicle to at most one. The vehicle start and end locations do not count here.  See [here](./concepts/route-structure-control) for more information.")
