...
/**
 * Defines when a break becomes necessary and how long it should be. Currently, each driver must have the same values specified.  See [here](./Concepts/Drivers%20Working%20Hours.htm) for more information.
 */
@ApiModel(description = "Defines when a break becomes necessary and how long it should be. Currently, each driver must have the same values specified.  See [here](./Concepts/Drivers%20Working%20Hours.htm) for more information.")
@JsonPropertyOrder({
