 ...
 */
@ApiModel(description = "Contains summary values of the events on the way from the previous stop to the current stop, including the driving time. The very first stop of a route has a way report with empty values.")
@JsonPropertyOrder({
  StopReportForWayToStop.JSON_PROPERTY_DISTANCE,
  StopReportForWayToStop.JSON_PROPERTY_DRIVING_TIME,
  StopReportForWayToStop.JSON_PROPERTY_WAITING_TIME,
  StopReportForWayToStop.JSON_PROPERTY_BREAK_TIME,
  StopReportForWayToStop.JSON_PROPERTY_REST_TIME
})
...
public class StopReportForWayToStop {
  ...
  public StopReportForWayToStop() { 
  }

  public StopReportForWayToStop distance(Integer distance) {
  ...
  **/
  ...
  public StopReportForWayToStop drivingTime(Integer drivingTime) {
  ...
  **/
  ...
  public StopReportForWayToStop waitingTime(Integer waitingTime) {
  ...
  **/
  ...
  public StopReportForWayToStop breakTime(Integer breakTime) {
  ...
  **/
  ...
  public StopReportForWayToStop restTime(Integer restTime) {
  ...
  **/
  ...
  /**
   * Return true if this Stop_reportForWayToStop object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    StopReportForWayToStop stopReportForWayToStop = (StopReportForWayToStop) o;
    return Objects.equals(this.distance, stopReportForWayToStop.distance) &&
        Objects.equals(this.drivingTime, stopReportForWayToStop.drivingTime) &&
        Objects.equals(this.waitingTime, stopReportForWayToStop.waitingTime) &&
        Objects.equals(this.breakTime, stopReportForWayToStop.breakTime) &&
        Objects.equals(this.restTime, stopReportForWayToStop.restTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class StopReportForWayToStop {\n");
