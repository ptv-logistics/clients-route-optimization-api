...
public class Stop {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `tripId` to the URL query string
    if (getTripId() != null) {
      joiner.add(String.format("%stripId%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getTripId()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
