...
import com.ptvgroup.developer.client.routeoptimization.model.Event;
import com.ptvgroup.developer.client.routeoptimization.model.StopReport;
import com.ptvgroup.developer.client.routeoptimization.model.Violation;
import com.ptvgroup.developer.client.routeoptimization.model.WayReport;
...
/**
 * A stop groups subsequent deliveries and/or pickups at the same location. At a customer location, transports are scheduled in order of their type: deliveries before pickups. At a depot location a stop groups either deliveries or pickups.  See [here](./Concepts/Locations,%20Transports%20and%20Stops.htm) for more information.
 */
@ApiModel(description = "A stop groups subsequent deliveries and/or pickups at the same location. At a customer location, transports are scheduled in order of their type: deliveries before pickups. At a depot location a stop groups either deliveries or pickups.  See [here](./Concepts/Locations,%20Transports%20and%20Stops.htm) for more information.")
@JsonPropertyOrder({
  Stop.JSON_PROPERTY_LOCATION_ID,
  Stop.JSON_PROPERTY_TRIP_ID,
...
public class Stop {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "A reference to a location. Usually, goods are picked up or delivered here. If no goods are picked up or delivered, it is the location where a route or a trip starts or ends.")
  ...
  public Stop tripId(String tripId) {
    this.tripId = tripId;
    return this;
  }

   /**
   * The trip ID groups several subsequent stops. The first stop and the last stop of a route may not have a trip ID only if the vehicle that is assigned to this route has a start or an end location, respectively.  See [here](./Concepts/Routes%20and%20Trips.htm) for more information.
   * @return tripId
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The trip ID groups several subsequent stops. The first stop and the last stop of a route may not have a trip ID only if the vehicle that is assigned to this route has a start or an end location, respectively.  See [here](./Concepts/Routes%20and%20Trips.htm) for more information.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "Contains summary values of the events on the way from the previous stop to the current stop, including the driving time. The very first stop of a route has a way report with empty values.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "Contains summary values of the events at a stop, including the arrival time, the departure time and the service time It also contains information about the loaded quantities when leaving the current stop.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "A list of events that occur at this stop. An event specifies what happens on a route at a certain point in time. It can describe the driver's activity such as performing service or waiting, or it can denote the start/end of a route/trip.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.locationId, stop.locationId) &&
        Objects.equals(this.tripId, stop.tripId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(locationId, tripId, deliveryIds, pickupIds, reportForWayToStop, reportForStop, eventsOnWayToStop, eventsAtStop, violationsOnWayToStop, violationsAtStop);
  }
