...
import com.ptvgroup.developer.client.routeoptimization.model.EventType;
 ...
 */
@ApiModel(description = "An event specifies what happens on a route at a certain point in time. It can describe the driver's activity such as driving or performing service, or it can denote the start/end of a route/trip.")
@JsonPropertyOrder({
...
public class Event {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The start time of the event formatted according to [RFC 3339](https://tools.ietf.org/html/rfc3339).")
