...
namespace PTV.Developer.Clients.routeoptimization.Model
{
    ...
    public partial class Stop : IEquatable<Stop>, IValidatableObject
    {
        ...
        /// <param name="tripId">The trip ID groups several subsequent stops. The first stop and the last stop of a route may not have a trip ID only if the vehicle that is assigned to this route has a start or an end location, respectively.  See [here](./Concepts/Routes%20and%20Trips.htm) for more information..</param>
        ...
        /// </summary>
        /// <value>The trip ID groups several subsequent stops. The first stop and the last stop of a route may not have a trip ID only if the vehicle that is assigned to this route has a start or an end location, respectively.  See [here](./Concepts/Routes%20and%20Trips.htm) for more information.</value>
