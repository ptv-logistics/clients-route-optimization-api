...
namespace PTV.Developer.Clients.routeoptimization.Model
{
    ...
    public partial class Location : IEquatable<Location>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Location" /> class.
        /// </summary>
        /// <param name="id">A unique ID for this location. This ID can be used to reference the location from other elements, for example from transports or vehicles. For multiple identical plans the optimized routes will always be the same. But please be aware that different IDs can lead to different results. (required).</param>
        ...
        public Location(string id = default(string), LocationType? type = default(LocationType?), double latitude = default(double), double longitude = default(double), List<TimeInterval> openingIntervals = default(List<TimeInterval>), CustomerLocationAttributes customerLocationAttributes = default(CustomerLocationAttributes))
        {
        ...
        /// </summary>
        /// <value>A unique ID for this location. This ID can be used to reference the location from other elements, for example from transports or vehicles. For multiple identical plans the optimized routes will always be the same. But please be aware that different IDs can lead to different results.</value>
