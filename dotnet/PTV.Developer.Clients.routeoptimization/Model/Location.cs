...
namespace PTV.Developer.Clients.routeoptimization.Model
{
    ...
    public partial class Location : IValidatableObject
    {
        ...
        public Location(string id = default(string), LocationType? type = default(LocationType?), double? latitude = default(double?), double? longitude = default(double?), RoadAccess roadAccess = default(RoadAccess), bool? includeLastMeters = true, bool? matchSideOfStreet = false, bool? applyVehicleDependentServiceTimeFactor = true, List<TimeInterval> openingIntervals = default(List<TimeInterval>), DepotLocationAttributes depotLocationAttributes = default(DepotLocationAttributes), CustomerLocationAttributes customerLocationAttributes = default(CustomerLocationAttributes))
        {
            ...
            // use default value if no "applyVehicleDependentServiceTimeFactor" provided
            this.ApplyVehicleDependentServiceTimeFactor = applyVehicleDependentServiceTimeFactor ?? true;
