...
namespace PTV.Developer.Clients.routeoptimization.Model
{
    ...
    public partial class ErrorResponse : IEquatable<ErrorResponse>, IValidatableObject
    {
        ...
        public ErrorResponse(string traceId = default(string), string errorId = default(string), string description = default(string), string errorCode = default(string), List<CausingError> causes = default(List<CausingError>), Dictionary<string, Object> details = default(Dictionary<string, Object>))
        {
