...
namespace PTV.Developer.Clients.routeoptimization.Model
{
    ...
    public partial class Route : IEquatable<Route>, IValidatableObject
    {
        ...
        /// <param name="stops">A sequence of stops along this route. Each stop is at a specific location, either a customer location or a depot location. At a customer location, transports are scheduled in order of their type: deliveries before pickups. The sequence of deliveries and pickups is always sorted by Last In - First Out (LIFO). At a depot location a stop groups either deliveries or pickups.  See [here](./Concepts/Locations,%20Transports%20and%20Stops.htm) for more information. (required).</param>
        ...
        /// </summary>
        /// <value>A sequence of stops along this route. Each stop is at a specific location, either a customer location or a depot location. At a customer location, transports are scheduled in order of their type: deliveries before pickups. The sequence of deliveries and pickups is always sorted by Last In - First Out (LIFO). At a depot location a stop groups either deliveries or pickups.  See [here](./Concepts/Locations,%20Transports%20and%20Stops.htm) for more information.</value>
