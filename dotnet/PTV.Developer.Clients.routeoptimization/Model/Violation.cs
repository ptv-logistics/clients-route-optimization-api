...
namespace PTV.Developer.Clients.routeoptimization.Model
{
    ...
    public partial class Violation : IEquatable<Violation>, IValidatableObject
    {
        ...
        [DataMember(Name = "numberOfStopsExceedance", EmitDefaultValue = false)]
        ...
        public bool Equals(Violation input)
        {
            ...
            return 
                ...
                (
                    this.NumberOfStopsExceedance == input.NumberOfStopsExceedance ||
                    this.NumberOfStopsExceedance.Equals(input.NumberOfStopsExceedance)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.NumberOfStopsExceedance.GetHashCode();
