...
namespace PTV.Developer.Clients.routeoptimization.Model
{
    ...
    public partial class WayReport : IValidatableObject
    {
        ...
        /// <param name="waitingTime">The sum of waiting times between the departure from the previous stop and the arrival at this stop [s]. (required).</param>
        ...
        /// <param name="restTime">The sum of rest times between the departure from the previous stop and the arrival at this stop [s]. (required).</param>
        public WayReport(int? distance = default(int?), int? drivingTime = default(int?), int? waitingTime = default(int?), int? breakTime = default(int?), int? restTime = default(int?))
        {
            ...
            if (waitingTime == null)
            {
                throw new ArgumentNullException("waitingTime is a required property for WayReport and cannot be null");
            }
            ...
            if (restTime == null)
            {
                throw new ArgumentNullException("restTime is a required property for WayReport and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The sum of waiting times between the departure from the previous stop and the arrival at this stop [s].</value>
        ...
        /// </summary>
        /// <value>The sum of rest times between the departure from the previous stop and the arrival at this stop [s].</value>
