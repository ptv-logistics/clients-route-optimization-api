...
namespace PTV.Developer.Clients.routeoptimization.Model
{
    ...
    public partial class Plan : IEquatable<Plan>, IValidatableObject
    {
        ...
        [DataMember(Name = "planningHorizon", EmitDefaultValue = true)]
        ...
        public bool Equals(Plan input)
        {
            ...
            return 
                ...
                (
                    ...
                    this.PlanningHorizon.Equals(input.PlanningHorizon))
                ) && 
                (
                ...
                (
                    this.UnplannedVehicleIds == input.UnplannedVehicleIds ||
                    this.UnplannedVehicleIds != null &&
                    input.UnplannedVehicleIds != null &&
                    this.UnplannedVehicleIds.SequenceEqual(input.UnplannedVehicleIds)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.PlanningHorizon.GetHashCode();
                }
                ...
                if (this.UnplannedVehicleIds != null)
                {
                    hashCode = (hashCode * 59) + this.UnplannedVehicleIds.GetHashCode();
                }
