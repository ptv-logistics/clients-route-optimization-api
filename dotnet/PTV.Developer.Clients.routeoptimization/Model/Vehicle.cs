...
namespace PTV.Developer.Clients.routeoptimization.Model
{
    ...
    public partial class Vehicle : IEquatable<Vehicle>, IValidatableObject
    {
        ...
        /// <param name="alternativeCapacities">List of alternative capacities. Each entry in this array must be valid capacities, more details are described in **capacities**. If a route cannot be driven with the **capacities**, alternative capacities may be chosen by the optimization considering the chosen **capacitiesChangePosition**.  See [here](./Concepts/Alternative%20Capacities.htm) for more information..</param>
        ...
        /// <param name="profile">The profile defines attributes of the vehicle relevant to determine travel times and distances between any two locations. Default profile is _EUR_TRAILER_TRUCK_. See [here](./Concepts/Profiles%20and%20Countries.htm) for a complete list of allowed values. (default to &quot;EUR_TRAILER_TRUCK&quot;).</param>
        ...
        public Vehicle(string id = default(string), List<int> capacities = default(List<int>), List<List<int>> alternativeCapacities = default(List<List<int>>), CapacitiesChangePosition? capacitiesChangePosition = default(CapacitiesChangePosition?), List<string> equipment = default(List<string>), string profile = "EUR_TRAILER_TRUCK", string startLocationId = default(string), string endLocationId = default(string), bool ignoreMixedLoadingProhibitions = false)
        {
        ...
        /// </summary>
        /// <value>List of alternative capacities. Each entry in this array must be valid capacities, more details are described in **capacities**. If a route cannot be driven with the **capacities**, alternative capacities may be chosen by the optimization considering the chosen **capacitiesChangePosition**.  See [here](./Concepts/Alternative%20Capacities.htm) for more information.</value>
        ...
        /// </summary>
        /// <value>The profile defines attributes of the vehicle relevant to determine travel times and distances between any two locations. Default profile is _EUR_TRAILER_TRUCK_. See [here](./Concepts/Profiles%20and%20Countries.htm) for a complete list of allowed values.</value>
