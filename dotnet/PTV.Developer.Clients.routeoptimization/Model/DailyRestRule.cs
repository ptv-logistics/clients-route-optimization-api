...
namespace PTV.Developer.Clients.routeoptimization.Model
{
    ...
    public partial class DailyRestRule : IEquatable<DailyRestRule>, IValidatableObject
    {
        ...
        [DataMember(Name = "dailyRestTime", IsRequired = true, EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as DailyRestRule);
        }

        /// <summary>
        /// Returns true if DailyRestRule instances are equal
        /// </summary>
        /// <param name="input">Instance of DailyRestRule to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DailyRestRule input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.DailyRestTime == input.DailyRestTime ||
                    this.DailyRestTime.Equals(input.DailyRestTime)
                ) && 
                (
                    this.MaximumDrivingTimeBetweenDailyRests == input.MaximumDrivingTimeBetweenDailyRests ||
                    (this.MaximumDrivingTimeBetweenDailyRests != null &&
                    this.MaximumDrivingTimeBetweenDailyRests.Equals(input.MaximumDrivingTimeBetweenDailyRests))
                ) && 
                (
                    this.MaximumTravelTimeBetweenDailyRests == input.MaximumTravelTimeBetweenDailyRests ||
                    (this.MaximumTravelTimeBetweenDailyRests != null &&
                    this.MaximumTravelTimeBetweenDailyRests.Equals(input.MaximumTravelTimeBetweenDailyRests))
                ) && 
                (
                    this.DailyRestPosition == input.DailyRestPosition ||
                    this.DailyRestPosition.Equals(input.DailyRestPosition)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                hashCode = (hashCode * 59) + this.DailyRestTime.GetHashCode();
                if (this.MaximumDrivingTimeBetweenDailyRests != null)
                {
                    hashCode = (hashCode * 59) + this.MaximumDrivingTimeBetweenDailyRests.GetHashCode();
                }
                if (this.MaximumTravelTimeBetweenDailyRests != null)
                {
                    hashCode = (hashCode * 59) + this.MaximumTravelTimeBetweenDailyRests.GetHashCode();
                }
                hashCode = (hashCode * 59) + this.DailyRestPosition.GetHashCode();
                return hashCode;
            }
        }
        ...
        public IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DailyRestTime, must be a value less than or equal to 79200.", new [] { "DailyRestTime" });
            }

            // DailyRestTime (int) minimum
            if (this.DailyRestTime < (int)10800)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DailyRestTime, must be a value greater than or equal to 10800.", new [] { "DailyRestTime" });
            }

            // MaximumDrivingTimeBetweenDailyRests (int?) minimum
            if (this.MaximumDrivingTimeBetweenDailyRests < (int?)3600)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for MaximumDrivingTimeBetweenDailyRests, must be a value greater than or equal to 3600.", new [] { "MaximumDrivingTimeBetweenDailyRests" });
            }

            // MaximumTravelTimeBetweenDailyRests (int?) minimum
            if (this.MaximumTravelTimeBetweenDailyRests < (int?)3600)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for MaximumTravelTimeBetweenDailyRests, must be a value greater than or equal to 3600.", new [] { "MaximumTravelTimeBetweenDailyRests" });
            }
