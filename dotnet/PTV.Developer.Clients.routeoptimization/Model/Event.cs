...
namespace PTV.Developer.Clients.routeoptimization.Model
{
    ...
    public partial class Event : IEquatable<Event>, IValidatableObject
    {
        ...
        /// <param name="startTime">The start time of the event formatted according to [RFC 3339](https://tools.ietf.org/html/rfc3339). (required).</param>
        ...
        /// </summary>
        /// <value>The start time of the event formatted according to [RFC 3339](https://tools.ietf.org/html/rfc3339).</value>
